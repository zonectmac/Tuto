 ...
 */
package com.xinyanyuan.project.at15.view.xlist;
...
public class XListView extends ListView implements OnScrollListener {
			...
			super.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					if (onXListItemClickListener != null) {
						onXListItemClickListener.onItem(parent, view,
								position - 1, id);
					}
				}
			});
	...
	public interface OnXListItemClickListener {
		void onItem(AdapterView<?> parent, View view, int position, long id);
	}
}
