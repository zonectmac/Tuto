...
public class RegisterPage extends FakeActivity implements OnClickListener,
	...
	public void onCreate() {
		...
		if (layout != null) {
			...
			tvCountryNum = (TextView) activity
					.findViewById(Res.id.tv_country_num);
			tvCountryNum.setText("+" + currentCode);

			etPhoneNum = (EditText) activity
					.findViewById(Res.id.et_write_phone);
	...
	private void checkPhoneNum(String phone, String code) {
		...
		if (countryRules == null || countryRules.size() <= 0) {
			if (code == "86") {
				...
				int resId = getStringRes(activity,
						"smssdk_country_not_support_currently");
				if (resId > 0) {
					Toast.makeText(getContext(), resId, Toast.LENGTH_SHORT)
							.show();
				}
	...
	public void showDialog(final String phone, final String code) {
		...
		if (resId > 0) {
			...
			if (layout != null) {
				...
				((TextView) dialog.findViewById(Res.id.tv_phone))
						.setText(phoneNum);
				TextView tv = (TextView) dialog
						.findViewById(Res.id.tv_dialog_hint);
				...
				((Button) dialog.findViewById(Res.id.btn_dialog_ok))
				...
				((Button) dialog.findViewById(Res.id.btn_dialog_cancel))
						.setOnClickListener(new OnClickListener() {
							public void onClick(View v) {
								dialog.dismiss();
							}
