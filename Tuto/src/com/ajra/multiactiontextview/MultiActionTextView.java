...
public class MultiActionTextView
{
	...
	public static void setSpannableText(TextView textView, SpannableStringBuilder stringBuilder, int highLightTextColor)
	{
	...
	{
		inputObject.getStringBuilder().setSpan(new MultiActionTextViewClickableSpan(true)
		{
			@Override
	...
	{
		inputObject.getStringBuilder().setSpan(new MultiActionTextViewClickableSpan(false)
		{
			@Override
			public void onClick(View widget)
			{
